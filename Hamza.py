...
def banner():
	clear()
	wel = '# WELCOME TO SOMAIL-BRAND FIRST PAID TOOLS'
	wel2 = mark(wel, style='cyan')
	sol().print(wel2)
	au='AUTHOR    :  MuHammad Somail\nGITHUB    :  https://github.com/SOMAIL-BRAND\nWHATSAPP  :  +923185612237'
	pengembang1=nel(au,style="cyan")
	cetak(nel(pengembang1, title='CREATE BY SOMAIL-BRAND'))
	wel = '#  Please Buy A License First To Continue'
	wel2 = mark(wel, style='cyan')
	sol().print(wel2)
	aa=input('[•] Buy License  y / t : ')
	if aa in ['y','Y']:
		os.system('xdg-open https://wa.me/+923185612237')
	else:
		exit()
